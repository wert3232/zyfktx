...
inline fun SharedPreferences.Editor.putValues(key: String, vararg values: Any) {
    val json = Gson().toJson(values)
    //[0.5,0.5]
    putString(key, json)
}

inline fun SharedPreferences.getValues(key: String, def: List<String>? = null): List<String>? {
